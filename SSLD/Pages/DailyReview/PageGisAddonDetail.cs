...
public partial class PageGisAddonDetail
{
    ...
    [Parameter] public GisAddon Addon { get; set; }
    [Parameter] public DateTime StartDate { get; set; }
    [Parameter] public DateTime FinishDate { get; set; }
    private IQueryable<GisAddonValue> _values;
    private string _log;

    protected override Task OnParametersSetAsync()
    {
        _values = Db.GisAddonValues
    ...
    private async Task ExportToExcel()
    {
        ...
        var name = $"Данные по направлению {Addon.Gis.Name} -> {Addon.Name}";
        ...
        await Js.InvokeVoidAsync("saveAsFile",
            $"{Addon.Gis.Name} - {Addon.Name} - {DateTime.Now:yyyyMMdd-HHmmss}.xlsx",
