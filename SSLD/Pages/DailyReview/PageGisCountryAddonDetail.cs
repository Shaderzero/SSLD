...
public partial class PageGisCountryAddonDetail
{
    ...
    [Parameter] public GisCountryAddon Addon { get; set; }
    [Parameter] public DateTime StartDate { get; set; }
    [Parameter] public DateTime FinishDate { get; set; }
    private IQueryable<GisCountryAddonValue> _values;
    private string _log;

    protected override Task OnParametersSetAsync()
    {
        _values = Db.GisCountryAddonValues
    ...
    private async Task SaveRow(DayValue value)
    {
        ...
        {
            var val = new GisCountryAddonValue()
            {
    ...
    private async Task ExportToExcel()
    {
        ...
        var name = $"Данные по направлению {Addon.GisCountry.Gis.Name} -> {Addon.GisCountry.Country.Name} - {Addon.Name}";
        ...
        await Js.InvokeVoidAsync("saveAsFile",
            $"{Addon.GisCountry.Country.Name} - {Addon.Name} - {DateTime.Now:yyyyMMdd-HHmmss}.xlsx",
