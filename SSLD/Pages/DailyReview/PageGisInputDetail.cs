...
public partial class PageGisInputDetail
{
    ...
    private IQueryable<GisInputValue> _values;
    private string _log;

    protected override Task OnParametersSetAsync()
    {
        _values = Db.GisInputValues
    ...
    private async Task ExportToExcel()
    {
        ...
        var name = $"Данные по направлению {Gis.Name} -> Закачка ПХГ";
        ...
        await Js.InvokeVoidAsync("saveAsFile",
            $"{Gis.Name} - Закачка ПХГ - {DateTime.Now:yyyyMMdd-HHmmss}.xlsx",
