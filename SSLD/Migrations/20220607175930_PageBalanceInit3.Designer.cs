...
namespace SSLD.Migrations
{
    ...
    [Migration("20220607175930_PageBalanceInit3")]
    partial class PageBalanceInit3
    {
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYear", b =>
                {
                    ...
                    b.Property<string[]>("ChinaTxts")
                        .HasColumnType("text[]")
                        .HasColumnName("china_txts");

                    b.Property<double[]>("ChinaValues")
                        .HasColumnType("double precision[]")
                        .HasColumnName("china_values");

                    b.Property<string[]>("GasPhgTxts")
                        .HasColumnType("text[]")
                        .HasColumnName("gas_phg_txts");

                    b.Property<double[]>("GasPhgValues")
                        .HasColumnType("double precision[]")
                        .HasColumnName("gas_phg_values");

                    b.Property<string[]>("GasTovTxts")
                        .HasColumnType("text[]")
                        .HasColumnName("gas_tov_txts");

                    b.Property<double[]>("GasTovValues")
                        .HasColumnType("double precision[]")
                        .HasColumnName("gas_tov_values");

                    b.Property<string[]>("GpsTxts")
                        .HasColumnType("text[]")
                        .HasColumnName("gps_txts");

                    b.Property<double[]>("GpsValues")
                        .HasColumnType("double precision[]")
                        .HasColumnName("gps_values");

                    b.Property<string[]>("RepoTxts")
                        .HasColumnType("text[]")
                        .HasColumnName("repo_txts");

                    b.Property<double[]>("RepoValues")
                        .HasColumnType("double precision[]")
                        .HasColumnName("repo_values");
