...
namespace SSLD.Migrations
{
    ...
    [Migration("20220602193714_addLogToDzZr")]
    partial class addLogToDzZr
    {
            ...
            modelBuilder.Entity("SSLD.Data.DZZR.OperatorResource", b =>
                {
                    ...
                    b.HasIndex("InputFileLogId")
                        .HasDatabaseName("ix_operator_resources_input_file_log_id");
            ...
            modelBuilder.Entity("SSLD.Data.DZZR.OperatorResource", b =>
                {
                    b.HasOne("SSLD.Data.DailyReview.InputFileLog", "InputFileLog")
                        .WithMany()
                        .HasForeignKey("InputFileLogId")
                        .HasConstraintName("fk_operator_resources_input_files_logs_input_file_log_id");
