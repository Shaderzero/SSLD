...
namespace SSLD.Migrations
{
    ...
    [Migration("20220131093757_add_operator_resource_log")]
    partial class add_operator_resource_log
    {
            ...
            modelBuilder.Entity("SSLD.Data.DZZR.OperatorResource", b =>
                {
                    ...
                    b.HasIndex("GisId")
                        .HasDatabaseName("ix_operator_resources_gis_id");

                    b.HasIndex("LogId")
                        .HasDatabaseName("ix_operator_resources_log_id");
            ...
            modelBuilder.Entity("SSLD.Data.DZZR.OperatorResourceHour", b =>
                {
                    ...
                    b.HasIndex("OperatorResourceId")
                        .HasDatabaseName("ix_operator_resource_hours_operator_resource_id");
            ...
            modelBuilder.Entity("SSLD.Data.DZZR.OperatorResource", b =>
                {
                    b.HasOne("SSLD.Data.DailyReview.Gis", "Gis")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_operator_resources_gises_gis_id");

                    b.HasOne("SSLD.Data.DailyReview.InputFileLog", "Log")
                        .WithMany()
                        .HasForeignKey("LogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_operator_resources_input_files_logs_log_id");
