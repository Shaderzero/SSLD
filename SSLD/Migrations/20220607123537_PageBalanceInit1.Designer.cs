...
namespace SSLD.Migrations
{
    ...
    [Migration("20220607123537_PageBalanceInit1")]
    partial class PageBalanceInit1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.FileTypeSetting", b =>
                {
                    ...
                    b.Property<int>("LastHour")
                        .HasColumnType("integer")
                        .HasColumnName("last_hour");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.Forecast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("ForecastYearId")
                        .HasColumnType("integer")
                        .HasColumnName("forecast_year_id");

                    b.Property<string>("Fullname")
                        .HasColumnType("text")
                        .HasColumnName("fullname");

                    b.Property<bool>("InDayReview")
                        .HasColumnType("boolean")
                        .HasColumnName("in_day_review");

                    b.Property<bool>("InMain")
                        .HasColumnType("boolean")
                        .HasColumnName("in_main");

                    b.Property<long>("InputFileLogId")
                        .HasColumnType("bigint")
                        .HasColumnName("input_file_log_id");
                    ...
                    b.HasIndex("ForecastYearId")
                        .HasDatabaseName("ix_forecasts_forecast_year_id");

                    b.HasIndex("InputFileLogId")
                        .HasDatabaseName("ix_forecasts_input_file_log_id");

                    b.ToTable("forecasts", (string)null);
                });

            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastGisCountry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_forecast_gis_countries");

                    b.HasIndex("GisCountryId")
                        .HasDatabaseName("ix_forecast_gis_countries_gis_country_id");

                    b.HasIndex("ForecastId", "GisCountryId", "Month")
                        .IsUnique()
                        .HasDatabaseName("ix_forecast_gis_countries_forecast_id_gis_country_id_month");

                    b.ToTable("forecast_gis_countries", (string)null);
                });

            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_forecast_years");

                    b.HasIndex("Year")
                        .IsUnique()
                        .HasDatabaseName("ix_forecast_years_year");

                    b.ToTable("forecast_years", (string)null);
                });

            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYearChinaValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_forecast_year_china_value");

                    b.HasIndex("ForecastYearId", "Month")
                        .IsUnique()
                        .HasDatabaseName("ix_forecast_year_china_value_forecast_year_id_month");

                    b.ToTable("forecast_year_china_value", (string)null);
                });

            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYearGasTovValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_forecast_year_gas_tov_value");

                    b.HasIndex("ForecastYearId", "Month")
                        .IsUnique()
                        .HasDatabaseName("ix_forecast_year_gas_tov_value_forecast_year_id_month");

                    b.ToTable("forecast_year_gas_tov_value", (string)null);
                });

            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYearGpsValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_forecast_year_gps_value");

                    b.HasIndex("ForecastYearId", "Month")
                        .IsUnique()
                        .HasDatabaseName("ix_forecast_year_gps_value_forecast_year_id_month");

                    b.ToTable("forecast_year_gps_value", (string)null);
                });

            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYearPhgValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_forecast_year_phg_value");

                    b.HasIndex("ForecastYearId", "Month")
                        .IsUnique()
                        .HasDatabaseName("ix_forecast_year_phg_value_forecast_year_id_month");

                    b.ToTable("forecast_year_phg_value", (string)null);
                });

            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYearRepoValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_forecast_year_repo_value");

                    b.HasIndex("ForecastYearId", "Month")
                        .IsUnique()
                        .HasDatabaseName("ix_forecast_year_repo_value_forecast_year_id_month");

                    b.ToTable("forecast_year_repo_value", (string)null);
                });
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.GisAddonValue", b =>
                {
                    ...
                    b.HasIndex("ReportDate")
                        .HasDatabaseName("ix_gis_addon_values_report_date");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.GisCountryAddonType", b =>
                {
                    ...
                    b.HasIndex("StartDate")
                        .HasDatabaseName("ix_gis_country_addon_types_start_date");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.GisCountryAddonValue", b =>
                {
                    ...
                    b.HasIndex("ReportDate")
                        .HasDatabaseName("ix_gis_country_addon_values_report_date");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.GisCountryValue", b =>
                {
                    ...
                    b.HasIndex("ReportDate")
                        .HasDatabaseName("ix_gis_country_values_report_date");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.GisInputValue", b =>
                {
                    ...
                    b.HasIndex("ReportDate")
                        .HasDatabaseName("ix_gis_input_values_report_date");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.GisOutputValue", b =>
                {
                    ...
                    b.HasIndex("ReportDate")
                        .HasDatabaseName("ix_gis_output_values_report_date");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.InputFileLog", b =>
                {
                    ...
                    b.HasIndex("FileDate")
                        .HasDatabaseName("ix_input_files_logs_file_date");

                    b.HasIndex("FileTime")
                        .HasDatabaseName("ix_input_files_logs_file_time");

                    b.HasIndex("Filename")
                        .HasDatabaseName("ix_input_files_logs_filename");

                    b.HasIndex("InputTime")
                        .HasDatabaseName("ix_input_files_logs_input_time");
            ...
            modelBuilder.Entity("SSLD.Data.DZZR.OperatorResource", b =>
                {
                    ...
                    b.HasIndex("OperatorGisId", "Type", "SupplyDate", "ReportDate")
                        .IsUnique()
                        .HasDatabaseName("ix_operator_resources_operator_gis_id_type_supply_date_report_");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.Forecast", b =>
                {
                    b.HasOne("SSLD.Data.DailyReview.ForecastYear", null)
                        .WithMany("Forecasts")
                        .HasForeignKey("ForecastYearId")
                        .HasConstraintName("fk_forecasts_forecast_years_forecast_year_id");

                    b.HasOne("SSLD.Data.DailyReview.InputFileLog", "InputFileLog")
                        .WithMany()
                        .HasForeignKey("InputFileLogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_forecasts_input_files_logs_input_file_log_id");

                    b.Navigation("InputFileLog");
                });

            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastGisCountry", b =>
                {
                    b.HasOne("SSLD.Data.DailyReview.Forecast", "Forecast")
                        .WithMany("Countries")
                        .HasForeignKey("ForecastId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_forecast_gis_countries_forecasts_forecast_id");
                    ...
                    b.HasOne("SSLD.Data.DailyReview.GisCountry", "GisCountry")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_forecast_gis_countries_gis_countries_gis_country_id");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYearChinaValue", b =>
                {
                    b.HasOne("SSLD.Data.DailyReview.ForecastYear", "ForecastYear")
                        .WithMany("ChinaValues")
                        .HasForeignKey("ForecastYearId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_forecast_year_china_value_forecast_years_forecast_year_id");

                    b.Navigation("ForecastYear");
                });

            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYearGasTovValue", b =>
                {
                    b.HasOne("SSLD.Data.DailyReview.ForecastYear", "ForecastYear")
                        .WithMany("GasTovValues")
                        .HasForeignKey("ForecastYearId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_forecast_year_gas_tov_value_forecast_years_forecast_year_id");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYearGpsValue", b =>
                {
                    b.HasOne("SSLD.Data.DailyReview.ForecastYear", "ForecastYear")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_forecast_year_gps_value_forecast_years_forecast_year_id");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYearPhgValue", b =>
                {
                    b.HasOne("SSLD.Data.DailyReview.ForecastYear", "ForecastYear")
                        .WithMany("GasPhgValues")
                        .HasForeignKey("ForecastYearId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_forecast_year_phg_value_forecast_years_forecast_year_id");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYearRepoValue", b =>
                {
                    b.HasOne("SSLD.Data.DailyReview.ForecastYear", "ForecastYear")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_forecast_year_repo_value_forecast_years_forecast_year_id");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.ForecastYear", b =>
                {
                    b.Navigation("ChinaValues");

                    b.Navigation("Forecasts");

                    b.Navigation("GasPhgValues");

                    b.Navigation("GasTovValues");

                    b.Navigation("GpsValues");

                    b.Navigation("RepoValues");
                });
