...
namespace SSLD.Migrations
{
    ...
    [Migration("20220127124954_reload")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSLD.Data.DZZR.OperatorResource", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_operator_resource");

                    b.HasIndex("GisId")
                        .HasDatabaseName("ix_operator_resource_gis_id");

                    b.ToTable("operator_resource", (string)null);
                });
            ...
            modelBuilder.Entity("SSLD.Data.DZZR.OperatorResourceHour", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_operator_resource_hour");

                    b.HasIndex("OperatorResourceId")
                        .HasDatabaseName("ix_operator_resource_hour_operator_resource_id");

                    b.ToTable("operator_resource_hour", (string)null);
                });
            ...
            modelBuilder.Entity("SSLD.Data.DZZR.OperatorResource", b =>
                {
                    b.HasOne("SSLD.Data.DailyReview.Gis", "Gis")
                        .WithMany("OperatorResources")
                        .HasForeignKey("GisId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_operator_resource_gises_gis_id");
            ...
            modelBuilder.Entity("SSLD.Data.DZZR.OperatorResourceHour", b =>
                {
                    b.HasOne("SSLD.Data.DZZR.OperatorResource", "OperatorResource")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_operator_resource_hour_operator_resource_operator_resource_");
            ...
            modelBuilder.Entity("SSLD.Data.DailyReview.Gis", b =>
                {
                    ...
                    b.Navigation("OperatorResources");
                });
